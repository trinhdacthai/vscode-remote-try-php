                                    ...
                                    <div class="col-md-5">
                                        <div class="profile-info-left">
                                            ...
                                            <div class="staff-msg"><a class="btn btn-custom"
                                                                      href="apps-chat">Send Message</a></div>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                                        <ul class="personal-info">
                                            ...
                                            <li>
                                                ...
                                                <div class="text"><a href=""><span class="__cf_email__"
                                                                                   data-cfemail="701a1f181e141f15301508111d001c155e131f1d">[email&#160;protected]</span></a>
                                                </div>
                                            </li>
                                            <li>
                    ...
                    <div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="project-title"><a href="project_view">Hospital Administration</a>
                                </h4>
                                <small class="block text-ellipsis m-b-15">
